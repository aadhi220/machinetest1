  ...
  return (
    <>
      <div className="card">
        ...
        <p style={{fontSize:"13px"}} className="">what you'll get :</p>
        <span className="features">
          <i className="fa-regular fa-user fa-2xs"></i> upto 25 Users
        </span>
        <span className="features">
          <img style={{width:"1rem", mixBlendMode:"darken"}} src="https://cdn-icons-png.flaticon.com/512/3222/3222791.png" className="" alt="" /> Upto 25gb
          Storage
        </span>
        <span className="features">
